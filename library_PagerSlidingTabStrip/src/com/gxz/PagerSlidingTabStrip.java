...
public class PagerSlidingTabStrip extends HorizontalScrollView {
    ...
    private boolean smoothScrollWhenClickTab = false;//设置当点击TAB时,内容区域的ViewPager是否需要动画切换
     ...
     * 点击之后发生的事情
     * */
    private OnClickGon clickGon;
    public interface OnClickGon{
    	public void OnChang();
    }

    public void setOnClickGon(OnClickGon clickGon){
    	this.clickGon=clickGon;
    }
